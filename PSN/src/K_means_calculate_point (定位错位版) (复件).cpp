...
//    将Kmeans聚类出来的四个点用marker表示出来
    ...
    for(int i=0 ; i<12 ; i++)
    {
        if(fabs(array1[0]-array1[i])<0.9)
        {
          if(fabs(array2[0]-array2[i])<0.9 )   
          {
        ...
        {
          int find = findelse();
          if(fabs(array2[find]-array2[i])<0.9 )
          {
         ...
         polar4_y = point4_y/size4;
            ...
            if(size2 == 0)
            {
               if(fabs(polar1_y-polar3_y)<0.9)
                   ...
                   {
                    center_x = (polar1_x + polar3_x)/2;
                    center_y = (polar1_y + polar3_y)/2;
                   }
             }
            else if(size3 == 0)
            {
               if(fabs(polar1_y-polar4_y)<0.9)
                   {
                    center_x = (polar2_x + polar4_x)/2;
                    center_y = (polar2_y + polar4_y)/2;
                   }
               else
                   {
                    center_x = (polar1_x + polar4_x)/2;
